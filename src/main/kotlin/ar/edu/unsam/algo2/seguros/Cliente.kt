...
class Flota(var autos: Int) : Cliente(){
    override fun puedeCobrarSiniestro() = deuda <= maximoPermitido()
    fun maximoPermitido() = if(autos <= LIMITE_MUCHOS_AUTOS) MAXIMO_FLOTA_POCOS_AUTOS else MAXIMO_FLOTA_MUCHOS_AUTOS
}
